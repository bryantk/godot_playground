...
the round closes, if still held". What remains as policy is the tap-versus-hold distinction —
a tap that only turns in place — and that belongs in the profile. Note that the round
